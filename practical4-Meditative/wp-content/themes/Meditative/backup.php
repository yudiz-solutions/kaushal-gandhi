            ...
            <div class="container">
                <?php if (!empty($meditative_yoga_types['types'])) { ?>
                    <div class="yoga wow animate__animated animate__fadeInUp">
                        <?php
                        foreach ($meditative_yoga_types['types'] as $key) {
                        ?>
                            <div class="yoga-type">
                                ...
                                <button class="learn-more">
                                    <?php echo $key['button']['title']; ?><i class="fas fa-arrow-right"></i>
                                </button>
                            </div>
                        <?php } ?>
                    </div>
                            ...
                            <?php foreach ($meditative_yoga_experience['left_side'] as $key) { ?>
                                <div class="exp">
                                    <div class="lft-content">
                                        <?php if (!empty($meditative_yoga_experience['left_heading'])) { ?>
                                            <h1> <?php echo $key['left_heading']; ?></h1>
                                        <?php } ?>
                                        <?php if (!empty($meditative_yoga_experience['left_paragraph'])) { ?>
                                            <p> <?php echo $key['left_paragraph']; ?> </p>
                                        <?php } ?>
                                    </div>
                                    <div class="lft-img">
                                        <?php if (!empty($meditative_yoga_experience['left_image'])) { ?>
                    ...
                    <?php if (!empty($meditative_yoga_experience['right_side'])) { ?>
                        <div class="exp-rgt wow animate__animated animate__fadeInRight">
                            <?php foreach ($meditative_yoga_experience['right_side'] as $key) { ?>
                                <div class="exp">
                                    <?php if (!empty($meditative_yoga_experience['right_image'])) { ?>
                                        <div class="rgt-img">
                                            <img src="<?php echo $key['right_image']['url']; ?>" alt=" <?php $key['right_image']['alt']; ?>" />
                                        </div>
                                    <?php } ?>
                                    <div class="rgt-content">
                                        <?php if (!empty($meditative_yoga_experience['right_heading'])) { ?>
                                            <h1><?php echo $key['right_heading']; ?></h1>
                                        <?php } ?>
                                        <?php if (!empty($meditative_yoga_experience['right_paragraph'])) { ?>
            ...
            <?php if (!empty($classes_section['repeater_for_classes_section'])) { ?>
                <div class="class-grid wow animate__animated animate__fadeInUpBig">
                    <?php foreach ($classes_section['repeater_for_classes_section'] as $key) { ?>
                        <div class="class">
                            <?php if (!empty($classes_section['image'])) { ?>
                                <div class="class-img">
                                    <a href="class-1.html">
                            ...
                            <?php } ?>
                            <?php if (!empty($classes_section['heading'])) { ?>
                                <h2><a href="#"><?php echo $key['heading']; ?></a></h2>
                            <?php } ?>
                            <?php if (!empty($classes_section['paragraph'])) { ?>
            ...
            <div class="stories wow animate__animated animate__zoomIn">
                ...
                <div class="class-stories">
                    <div class="story">
                        ...
                        <div class="person">
                            <img src="<?php echo get_template_directory_uri(); ?>./assets/images/person_1.jpg" alt="person_1" />
                    ...
                    <div class="story">
                        ...
                        <div class="person">
                            <img src="<?php echo get_template_directory_uri(); ?>./assets/images/person_2.jpg" alt="person_2" />
                            <div class="person-name">
                                <h3>Kenny Buffer</h3>
                                <p>Customer</p>
                            </div>
                    ...
                    <div class="story">
                        ...
                        <div class="person">
                            <img src="<?php echo get_template_directory_uri(); ?>./assets/images/person_3.jpg" alt="person_3" />
                            <div class="person-name">
                                <h3>Kenny Buffer</h3>
                                <p>Customer</p>
                            </div>
