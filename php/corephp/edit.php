        ...
        <?php while ($row = mysqli_fetch_array($result)) { ?>
            <table>
                ...
                <tr>
                    <td>
                        <label for="">Bio:-</label>
                        <textarea name="Bio" id="" cols="30" rows="10"> <?php echo $row['Bio']; ?> </textarea>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <input type="Checkbox" name="Active_social_media[]" value="Instagram" <?php if (in_array('Instagram', $soci_ex)) {
                                                                                                    echo 'checked';
                                                                                                } ?>>Instagram
                        <input type="Checkbox" name="Active_social_media[]" value="Twitter" <?php if (in_array('Twitter', $soci_ex)) {
                                                                                                echo 'checked';
                                                                                            } ?>>Twitter
                        <input type="Checkbox" name="Active_social_media[]" value="Facebook" <?php if (in_array('Facebook', $soci_ex)) {
                                                                                                    echo 'checked';
                                                                                                } ?>>Facebook
                        <input type="Checkbox" name="Active_social_media[]" value="Whatsapp" <?php if (in_array('Whatsapp', $soci_ex)) {
                                                                                                    echo 'checked';
                                                                                                } ?>>Whatsapp
                        <input type="Checkbox" name="Active_social_media[]" value="Linkedin" <?php if (in_array('Linkedin', $soci_ex)) {
                                                                                                    echo 'checked';
                                                                                                } ?>>Linkedin
                    </td>
                </tr>
