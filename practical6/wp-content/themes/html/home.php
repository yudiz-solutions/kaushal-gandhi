    ...
    <?php if (!empty($team_section)) { ?>
        <section class="common-section home-team-section">
            <div class="container">
                ...
                <div class="text-center">
                    <a href="<?php echo (isset($team_section['button']['url'])) ? $team_section['button']['url']: ''; ?>" class="theme-btn white-btn"><?php echo (isset($team_section['button']['title'])) ? isset($team_section['button']['title']) : ''; ?></a>
                </div>
            </div>
        </section>
    <?php } ?>
